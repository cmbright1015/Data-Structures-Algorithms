...
3. Run "./Bright_Caleb_automated" this QuickSorts all 75 files, and creates .txt files with their execution times and average execution times.
4. To QuickSort single files run "./Bright_Caleb_QuickSort Bright_Caleb_input_10_XX.txt Bright_Caleb_output_10_XX.txt"
